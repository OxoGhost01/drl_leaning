...
cartpole_optimizer = optim.Adam(pixelcopter_policy.parameters(), lr=pixelcopter_hyperparameters["lr"])
load_model(pixelcopter_policy, cartpole_optimizer)
...
repo_id = "OxoGhost/Reinforce-Pixelcopter-PLE-v0"
push_to_hub(
    repo_id,
